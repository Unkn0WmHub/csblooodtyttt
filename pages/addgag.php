    ...
    <div class="col-md-12">
        <div class="card_header">
            <div class="svg_text_header">
                ...
                <svg viewBox="0 0 640 512"><path d="M38.8 5.1C28.4-3.1 13.3-1.2 5.1 9.2S-1.2 34.7 9.2 42.9l592 464c10.4 8.2 25.5 6.3 33.7-4.1s6.3-25.5-4.1-33.7L512.9 376.7C552.2 340.2 576 292.3 576 240C576 125.1 461.4 32 320 32c-67.7 0-129.3 21.4-175.1 56.3L38.8 5.1zm385.2 425L82.9 161.3C70.7 185.6 64 212.2 64 240c0 45.1 17.7 86.8 47.7 120.9c-1.9 24.5-11.4 46.3-21.4 62.9c-5.5 9.2-11.1 16.6-15.2 21.6c-2.1 2.5-3.7 4.4-4.9 5.7c-.6 .6-1 1.1-1.3 1.4l-.3 .3 0 0 0 0 0 0 0 0c-4.6 4.6-5.9 11.4-3.4 17.4c2.5 6 8.3 9.9 14.8 9.9c28.7 0 57.6-8.9 81.6-19.3c22.9-10 42.4-21.9 54.3-30.6c31.8 11.5 67 17.9 104.1 17.9c37 0 72.3-6.4 104.1-17.9z"/></svg>
                </div>
                <div class="header_text">
                    <div class="flex_header_top"><?= $Translate->get_translate_module_phrase('module_page_minisystem', '_ASAddGag') ?></div>
                    <div class="flex_header_bottom"><?= $Translate->get_translate_module_phrase('module_page_minisystem', '_ASAddGagDesc') ?></div>
                </div>
            </div>
        </div>
        <div class="grid_control">
            <div class="card">
                ...
                <div class="flex_over_adm scroll">
                    <?php foreach ($AdminSystemInfoGag as $gag) : ?>
                        <div class="card_lists_nakaz">
                            <?php if (!empty($General->arr_general['avatars'])) : ?>
                                <span class="info_card_table_head_item"><img class="admin_avatar" id="<?php $General->arr_general['avatars'] === 1 && print con_steam32to64($gag['steamid']) ?>" <?= $sz_i < '20' ? 'src' : 'data-src' ?>="<?= $General->getAvatar(con_steam32to64($gag['steamid']), 2) ?>" title="" alt=""></span>
                            <?php endif; ?>
                            <span class="info_card_table_head_item"><?= date('d.m.Y',$gag['created']) ?></span>
                            <span class="info_card_table_head_item"><?= action_text_clear(action_text_trim($gag['name'], 13)) ?></span>
                            <span class="info_card_table_head_item"><?= action_text_clear(action_text_trim($gag['admin_name'], 13)) ?></span>
                            <span class="info_card_table_head_item"><?= action_text_clear(action_text_trim($gag['reason'], 13)) ?></span>
                            <span class="info_card_table_head_item"><?php $createdTime = $gag['created']; $duration = $gag['duration']; if ($duration == 0) { echo $Translate->get_translate_phrase('_Forever'); } else { if (time() > $createdTime + $duration) { echo $Translate->get_translate_module_phrase('module_page_minisystem', '_ASExpLox'); } else { echo $Modules->action_time_exchange($duration); } } ?></span>
                            <div class="flex_del">
                                <a href="<?= $General->arr_general['site'] ?>profiles/<?php print $General->arr_general['only_steam_64'] === 1 ? con_steam32to64($gag['steamid']) : $gag['steamid'] ?>" target="_blank" class="btn_dev" data-tippy-content="<?= $Translate->get_translate_module_phrase('module_page_minisystem', '_ASProf') ?>" data-tippy-placement="top">
                    ...
                    <form id="add_gag_as">
                        <div class="input-container">
                            ...
                            <div class="input-wrapper">
                                ...
                                <input type="text" name="steam_player_gag" placeholder="STEAM_1:1:390... / 7656119803... / [U:1:1234234] / https://steamcommunity.com/profiles/..." style="margin-left: 42px;" required>
                            </div>
                        </div>
                        ...
                        <?php if($MiniSystem->GetSettings['time_choice'] == 0) : ?>
                            <div class="input-container">
                                ...
                                <div class="input-wrapper">
                                    ...
                                    <input type="number" name="duration_gag" placeholder="0" style="margin-left: 42px;">
                                </div>
                            </div>
                        <?php endif ?>
                        <div class="input-container">
                            ...
                            <div class="input-wrapper">
                                ...
                                <input type="text" name="reason_gag" placeholder="<?= $Translate->get_translate_module_phrase('module_page_minisystem', '_ASVorRes') ?>" style="margin-left: 42px;" required>
                            </div>
                        </div>
                    </div>
                    <input class="btn w100 btn5px" type="submit" value="<?= $Translate->get_translate_module_phrase('module_page_minisystem', '_ASAddGag') ?>">
                </form>
            </div>
        </div>
        <?php if ($page_max_gag != 1) : ?>
            <div class="pagination">
                ...
                <?php for ($v = $page_num; $v < min($page_num + 3, $page_max_gag); $v++) { ?>
                    <a href="<?= set_url_section(get_url(2), 'num', $v + 1) ?>" class="button_pagination current "><?= $v + 1 ?></a>
                <?php } ?>
                <?php if ($page_num != $page_max_gag) { ?>
                ...
                <?php } ?>
                <?php if ($page_num = $page_max_gag) { ?>
                    <a href="<?= set_url_section(get_url(2), 'num', $page_max_gag) ?>" class="button_pagination current " data-tippy-content="<?= $Translate->get_translate_phrase('_IntheEnd') ?>" data-tippy-placement="bottom">
                        <svg viewBox="0 0 448 512">
